...
const METRICS = [
  ...
  { label: 'Regex baseline on prose', value: '0.0%', sub: 'measured, motivates NER', color: 'text-rose-400' },
  { label: 'Retriever MRR', value: '0.340', sub: 'trained hybrid vs 0.330 BM25 · N = 781', color: 'text-teal-400' },
  { label: 'Readmission', value: 'CMS HRRP', sub: 'real published 30 day rates', color: 'text-indigo-400' },
  { label: 'Denial probability', value: 'Removed', sub: 'no claim outcome data; not faked', color: 'text-amber-400' },
